        ...
        <div className="container w-50">
            <form method="post" onSubmit={formSubmit} id='add-form'>
                <div className="form-group">
                    <input type="text" name="rollno" value={student.rollno} placeholder="Rollno" onChange={handleChange} className="form-control" required/>
                </div>
                <div className="form-group">
                ...
                <input type="submit" value="Add Student"  className="btn btn-warning mr-2"/>
                <input type="reset" value="Cancel"  className="btn btn-dark"/>
                <Link to='/' className='btn btn-success ml-3'>Home page</Link>
                {
                    (addStatus && <span className="alert alert-danger ml-3" >already exixts</span>)
                }
            </form>
